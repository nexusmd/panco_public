...
class WPBakeryShortCode_Panco_Map_Block extends Panco_Shortcode {
    ...
    protected function content( $atts, $content = null ) {
        ...
        wp_enqueue_script( 'google-maps', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBmu0Xqj7oZ1z3x_kerQU_sZKAZ_nrejhw&amp;callback=initMap&amp;language=eng', array(), null, false );


        if ($atts['featured_type'] == 'def') {

            $atts['has_title'] ? $title = '<div class="main-title">'. $atts['title'] .'</div>' : $title = '';

            $map_block .= '<div class="contacts-block">';
            $map_block .= '<div class="inner-wrapper">';
            // Info
            $map_block .= $title;
            // Map
            $map_block .= '<div class="map-wrapper"> <div class="map-box" id="map"></div> </div>';
...
<g>
  ...
  <path class="cls-1" d="M770.517,1077.03H753.478a1.452,1.452,0,0,1-1.477-1.42v-17.08a1.454,1.454,0,0,1,1.477-1.43h17.039a1.454,1.454,0,0,1,1.478,1.43v17.08A1.452,1.452,0,0,1,770.517,1077.03Zm-15.476-3.24h3.02v-9h-3.02v9Zm1.53-13.34a1.56,1.56,0,1,0-.04,3.11h0.021A1.561,1.561,0,1,0,756.571,1060.45Zm12.38,8.18c0-2.77-1.49-4.05-3.476-4.05a3.006,3.006,0,0,0-2.722,1.48v-1.27h-3.02c0.039,0.84,0,9,0,9h3.02v-5.03a2.017,2.017,0,0,1,.1-0.73,1.645,1.645,0,0,1,1.549-1.09c1.093,0,1.53.82,1.53,2.03v4.82h3.02v-5.16Zm-6.219-2.54,0.021-.03v0.03h-0.021Z" transform="translate(-752 -1057.09)"/>
            ...
            $atts['contact_subtitle'] ? $contact_subtitle = '<div class="locate">' . $atts['contact_subtitle'] . '</div>' : $contact_subtitle = '';
            ...
            if ($follow_fb || $follow_in) {
                ...
                $follow_content .= $follow_fb . $follow_in;
                $follow_content .= '</ul>';
        ...
        // Wrapper
        $output .= '<div class="block block-contacts">';
        $output .= '<div class="contacts-wrapper">';
        $output .= '<div class="contacts-inner-wrapper">';
