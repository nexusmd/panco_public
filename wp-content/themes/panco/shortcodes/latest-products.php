...
class WPBakeryShortCode_Panco_Latest_Products extends Panco_Shortcode {
    ...
    protected function content( $atts, $content = null ) {
        ...
        $output .= $title;
        $output .= '<section class="items-slider-wrap mt-6">';

        // Slider section
        $output .= '<div class="slider-container">';
        $output .= '<div class="item-slider home">';
        $output .= do_shortcode('[recent_products per_page="12" columns="4" orderby="date" order="ASC"]');
        $output .= '</div>';
        $output .= '</div>';
